...
GRANT SELECT, INSERT, UPDATE ON public.tenant_signups TO saw_app;--> statement-breakpoint
GRANT SELECT ON public.tenant_signups TO saw_readonly;--> statement-breakpoint
